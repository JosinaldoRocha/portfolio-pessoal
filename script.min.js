...
function scrollToSection(e) {
  ...
  if (t) {
    ...
    (n =
      "#projects" === e
        ? t.offsetTop - 70
        : t.offsetTop - (window.innerHeight - t.clientHeight) / 2),
...
prevButton.addEventListener("click", prevCard),
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    e.addEventListener("submit", function (l) {
      l.preventDefault();
      let r = document.getElementById("nome").value,
        s = document.getElementById("email").value,
        i = document.getElementById("assunto").value,
      ...
      let d = {
        ...
        html: `<p>Nome: ${r}</p><br/><p>Email: ${s}</p><br/><p>Assunto: ${i}</p><br/><p>Mensagem: ${a}</p>`,
      };
      fetch("https://api-mail-gun-h0if.onrender.com/send-email", {
        ...
        .then((e) => {
          e.ok
            ? ((o.style.display = "none"), (t.style.display = "block"))
  ...
  document.addEventListener("DOMContentLoaded", function () {
    let e = document.querySelectorAll("nav a");
    ...
    let t = document.querySelectorAll("footer a");
